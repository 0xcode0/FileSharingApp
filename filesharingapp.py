...
Label(root, text="Choose your action", font=('Acumin Variable Concept',20,'bold'),bg="#f4fdfe").place(x=20, y=30)
...
#Label Section
Label(root, text="Send",font=('Cascadia Code',15,'bold'),bg="#f4fdfe").place(x=70, y=200)
Label(root, text="Receive",font=('Cascadia Code',15,'bold'),bg="#f4fdfe").place(x=300, y=200)

background=PhotoImage(file="Image/background.png")
Label(root,width=450, image=background,).place(x=-5,y=323)
